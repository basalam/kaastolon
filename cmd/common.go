...
func AddCommonFlags(cmd *cobra.Command, cfg *CommonConfig) {
	...
	cmd.PersistentFlags().StringVar(&cfg.HealthProbeListenAddress, "health-probe-listen-address", "0.0.0.0:8081", "Health probe listen address, /healthz and /readyz will be available")
